 ...
 * @author zinic
 */
public class ReadAttributes extends AbstractJmxCommand {

    public ReadAttributes(ConfigurationManager configurationManager) {
    ...
    public CommandResult perform(String[] arguments) {
        if (arguments.length != 2) {
            return new InvalidArguments("Expecting MBean full-name or MBean search string and attribute name.");
        }
